...
Let us now have a look at the bias values between TROPOMI and GEOS-CF interpolated TROPOMI for fire and non-fire dates. 

```{r, message=F, warning=F}
bias_aug_8  
mean(fire_date_plot_aug_8$NO2_Concentration)
mean(predicted_values_tropomi_aug_8)

bias_nov_11
mean(fire_date_plot_nov_11$NO2_Concentration_nov)
mean(predicted_values_tropomi_nov_11)
```

The above values show bias values for non-fire dates 
```{r, message=F, warning=F}
bias_1_aug_18  
mean(fire_date_plot_aug_18$NO2_Concentration)
mean(predicted_values_tropomi_aug_18)
bias_1_aug_24
mean(fire_date_plot_aug_24$NO2_Concentration)
mean(predicted_values_tropomi_aug_24)
bias_1_aug_25
mean(fire_date_plot_aug_25$NO2_Concentration)
mean(predicted_values_tropomi_aug_25)
bias_1_nov_22
mean(fire_date_plot_nov_22$NO2_Concentration_nov)
mean(predicted_values_tropomi_nov_22)
bias_1_nov_23
mean(fire_date_plot_nov_23$NO2_Concentration_nov)
mean(predicted_values_tropomi_nov_23)
bias_1_nov_28
mean(fire_date_plot_nov_28$NO2_Concentration_nov)
mean(predicted_values_tropomi_nov_28)
```
